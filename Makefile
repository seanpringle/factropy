...
imgui/imgui.o: CFLAGS=-O3 -std=c++11 -g -Wall -DNDEBUG -Iimgui -Iraylib/src/external -Iraylib/src/external/glfw/include
...
src/raylib-ex.o: CFLAGS=-O3 -std=c99 -g -Wall $(DENOISE) -DNDEBUG -D_POSIX_C_SOURCE=199309L -Iraylib/src -Iraylib/src/external/glfw/include
src/raylib-ex.o: src/raylib-ex.c src/raylib-ex.h
	$(CC) $(CFLAGS) -c $< -o $@

src/raylib-glfw.o: CFLAGS=-O3 -std=c99 -g -Wall -DNDEBUG -D_POSIX_C_SOURCE=199309L -Iraylib/src/external/glfw/src
src/raylib-glfw.o: raylib/src/rglfw.c
	$(CC) $(CFLAGS) -c $< -o $@

wren/src/vm/%.o: CFLAGS=-O3 -std=c99 -g -Wall -DNDEBUG -Iwren/src/include -Iwren/src/optional -Iwren/src/vm
