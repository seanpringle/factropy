...
dev: LFLAGS=-lm -lGL -lm -lpthread -ldl -lrt -lX11 -L$(HOME)/lib -Wl,-rpath,$(HOME)/lib -lwren
...
rel: LFLAGS=-lm -lGL -lm -lpthread -ldl -lrt -lX11 -L$(HOME)/lib -Wl,-rpath,$(HOME)/lib -lwren
